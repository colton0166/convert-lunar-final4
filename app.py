...
def convert():
    ...
    lunar_month_str = f"閏{number_to_chinese(lunar_date.lunar_month)}" if getattr(lunar_date, 'lunar_is_leap', False) else number_to_chinese(lunar_date.lunar_month)
    lunar_str = f"{number_to_chinese(lunar_date.lunar_year)}年{lunar_month_str}月{lunar_day_to_chinese(lunar_date.lunar_day)}"
